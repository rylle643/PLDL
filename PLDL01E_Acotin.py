...
total_dedction = sss_contribution+philhealth_contribution+tax_contribution+pagibig_contribution
net_income = gross_income-total_dedction
...
#contribution, philhealth contribution, tax contribution
print(name_of_the_employee)
print(net_income)
print(gross_income)
print(total_dedction)
